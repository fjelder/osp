          ...
          <div class="flex flex-col mb-6 lg:justify-between lg:flex-row md:mb-8">
            <h2
              ...
              <span class="inline-block mb-1 sm:mb-4">
                Nasza
                <span class="text-5xl text-red-700 underline">R</span>emiza<br class="hidden md:block" />
      ...
      <div class="flex items-center justify-center -mx-4 lg:pl-8 lg:order-1">
        <div class="flex flex-col items-end px-3">
          <img class="object-cover mb-6 rounded shadow-lg h-28 sm:h-48 xl:h-56 w-28 sm:w-48 xl:w-56"
            src="{{Storage::url('img/wizualizacje/wizualizacja_03.jpg')}}" alt=""
            onmousedown="window.alert('Obraz chroniony prawem autorskim. Kopiowanie wymaga uzyskania zgody autora');" />
          <img class="object-cover w-20 h-20 rounded shadow-lg sm:h-32 xl:h-40 sm:w-32 xl:w-40"
            src="{{Storage::url('img/wizualizacje/wizualizacja_01.jpg')}}" alt=""
            onmousedown="window.alert('Obraz chroniony prawem autorskim. Kopiowanie wymaga uzyskania zgody autora');" />
        </div>
        <div class="px-3">
          <img class="object-cover w-40 h-40 rounded shadow-lg sm:h-64 xl:h-80 sm:w-64 xl:w-80"
            src="{{Storage::url('img/wizualizacje/wizualizacja_02.jpg')}}" alt=""
            onmousedown="window.alert('Obraz chroniony prawem autorskim. Kopiowanie wymaga uzyskania zgody autora');" />
        </div>
      </div>
    </div>
