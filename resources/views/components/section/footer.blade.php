@if(config('set.visibleSection.footer'))
<footer class="bg-gray-100">
    <div class="px-4 pt-16 mx-auto border-t sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
            <div class="sm:col-span-2">
                <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
                    <svg class="w-8 text-red-accent-400" viewBox="0 0 24 24" stroke-linejoin="round" stroke-width="2"
                    ...
                    <span class="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase ">Ochotnicza Straż Pożarna
                        w
                        Robakowie <br />
            ...
            <div class="space-y-2 text-sm">
                ...
                <div class="flex">
                    ...
                    <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email"
                        class="text-red-400 transition-colors duration-300 hover:text-red-800">info @osprobakowo.pl</a>
                </div>
                <div class="flex">
                    <p class="mr-1 text-gray-800">Adres:</p>
                    <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer"
                        ...
                        ul. Wiejska 15, Robakowo
                    </a>
                </div>
            </div>
            <div>
                <span class="text-base font-bold tracking-wide text-gray-900">Media społecznościowe</span>
        ...
        <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
            <p class="text-sm text-gray-600">© Copyright 2021 OSP Robakowo.</p>
            <ul class="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
                ...
                <li>
                    <a href="/"
                        class="text-sm text-gray-600 transition-colors duration-300 hover:text-red-accent-400">Polityka
                        prywatności</a>
                </li>
                <li>
                    <a href="/"
