    ...
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div class="flex flex-col items-center mb-6 space-x-10 lg:justify-between lg:flex-row md:mb-8">
            ...
            <div class="flex flex-col flex-wrap items-center flex-1 space-y-5 lg:space-x-5 lg:flex-row">
                ...
                <a href="https://osp.kornik.pl/" target="_blank" class="">
                    <img src="{{Storage::url('img/partners/desktop_logo.png')}}" alt="OSP Kórnik" />
                </a>
                <a href="https://robakowoosiedle.kornik.pl/" target="_blank" class="">
                    <img src="{{Storage::url('img/partners/logo-robakowo_osiedle_0.png')}}" alt="Robakowo Osiedle" />
                </a>
            </div>
        </div>
    </div>
