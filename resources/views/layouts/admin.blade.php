...
<head>
    ...
    <link rel="stylesheet" href="{{Storage::url('fonts/inter/inter.css')}}">
...
<body class="relative inter-font text-zinc-700">
    @livewire('navigation-menu')

    <nav
        class="hidden sticky top-0 z-10 bg-white border-gray-200 border-b dark:border-slate-300/10 px-2 sm:px-4 py-2.5 dark:bg-slate-900">
        <div class="flex flex-wrap items-center justify-between h-12">
            <a href="#" class="flex">
                ...
                <span class="self-center text-lg font-semibold text-zinc-600 whitespace-nowrap dark:text-white">OSP
                    Robakowo</span>
                <span class="text-3xl text-red-500">.</span>
                <span class="self-center text-sm font-medium text-indigo-400">#administracja</span>
            </a>
    ...
    <aside
        class="fixed inset-0 hidden w-64 overflow-y-auto border-r border-gray-200 lg:block top-16 bg-slate-100 dark:bg-slate-900 dark:border-slate-300/10"
        aria-label="Sidebar">
        <div class="px-3 py-4 bg-slate-100 dark:bg-slate-900">
            <ul class="space-y-2">
                <li>
                    <a href="#"
    ...
    <div class="flex flex-col lg:ml-64">
        ...
        <main class="flex-1 px-8 py-6 bg-white dark:bg-slate-900">
            <!-- breadcrumbs -->
            <nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-slate-100 dark:bg-slate-800 dark:border-slate-300/10"
        ...
        <footer
            class="p-4 bg-white border-t border-b border-gray-200 dark:border-slate-300/10 md:flex md:items-center md:justify-between md:p-6 dark:bg-slate-900">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com"
                    class="hover:underline" target="_blank">Flowbite™</a>. All Rights
                Reserved.
            </span>
