                    ...
                    <form action="" method="post">
                        <div class="grid grid-cols-1 md:grid-cols-2 ">
                            ...
                            <div class="p-5 text-sm text-zinc-700">
                                ...
                                <div class="mb-2">
                                    <label for="nip" class="text-zinc-400">Nazwa organizacji</label>
                                    <input type="text" value="Ochotnicza Straż Pożarna w Robakowie"
                                        disabled="disabled" />
                                </div>

                                <div class="mb-2">
                                    <label for="nip" class="text-zinc-400">NIP</label>
                                    <input type="text" value="123 456 21 85" class="focus:outline-none" />
                                </div>

                                <div class="mb-2">
                                    <label for="nip" class="text-zinc-400">Regon</label>
                                    <input type="text" value="159 874 963" />
                                </div>

                                <div class="mb-2">
                                    <label for="nip" class="text-zinc-400">KRS</label>
                                    <input type="text" value="00000254864" />
                                </div>
