...
<body class="relative flex flex-col max-h-screen min-h-screen dark inter-font">


    <nav class="bg-white border-gray-200 border-b dark:border-slate-300/10 px-2 sm:px-4 py-2.5 dark:bg-slate-900">
    ...
    <div class="flex flex-1 overflow-hidden">
        <aside
            class="w-64 overflow-y-auto border-r border-gray-200 bg-gray-50 dark:bg-slate-900 dark:border-slate-300/10"
            aria-label="Sidebar">
        ...
        <div class="flex flex-col flex-1 overflow-y-auto">
            <main class="flex-1 px-8 py-6 bg-white dark:bg-slate-900">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi dignissimos culpa enim? Corporis ducimus
                incidunt in numquam vero eaque consectetur. In veritatis rerum explicabo animi, doloremque ipsam sit
                temporibus sunt! Architecto facilis, similique iusto delectus sequi voluptatem ducimus odio! Soluta
                illum
                earum accusantium ad quidem architecto nulla adipisci temporibus ut, ducimus quaerat voluptates, sunt
                reiciendis omnis at? Mollitia voluptates eos sed rerum quod qui eaque, nobis minima eum tempore
                molestiae
                est odio vero, aut harum blanditiis asperiores dolor enim, consequatur dignissimos! Possimus laborum
                facilis
                praesentium amet optio hic vero nihil rem illum? Excepturi, explicabo aliquid? Assumenda corporis maxime
                nam
                veritatis.
            </main>
            <footer
