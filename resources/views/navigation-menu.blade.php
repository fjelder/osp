<nav x-data="{ open: false }"
    class="sticky top-0 z-10 bg-white border-gray-200 border-b dark:border-slate-300/10 px-2 sm:px-4 py-2.5 dark:bg-slate-900">
        ...
        <div class="flex justify-between h-12">
            <div class="flex">
                ...
                <div class="flex items-center flex-shrink-0">
                    ...
                    <span class="ml-4 text-lg font-semibold text-zinc-600 whitespace-nowrap dark:text-white">OSP
                        Robakowo</span>
